        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              link="https://github.com/KS1/insta"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              link="https://github.com/cj8355/PinKO"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              link="https://github.com/Honorinenn/workout-tracker"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              link="https://github.com/Honorinenn/Weather-Dash-Board"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              link="https://github.com/Honorinenn/book-search-engine "
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              link="https://github.com/Honorinenn/note-take"
            />
          </Col>
        </Row>
      </Container>
